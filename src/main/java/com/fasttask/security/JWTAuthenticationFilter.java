...
import static com.fasttask.security.Constants.HEADER_AUTHORIZACION_KEY;
import static com.fasttask.security.Constants.ISSUER_INFO;
import static com.fasttask.security.Constants.SUPER_SECRET_KEY;
import static com.fasttask.security.Constants.TOKEN_BEARER_PREFIX;
import static com.fasttask.security.Constants.TOKEN_EXPIRATION_TIME;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			Test credenciales = new ObjectMapper().readValue(request.getInputStream(), Test.class);
